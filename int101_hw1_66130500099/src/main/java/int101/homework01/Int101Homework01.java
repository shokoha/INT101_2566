...
public class Int101Homework01 {
    ...
    static void work03UseOfUtilityClass() {
        System.out.println( "Your BMI = " + MyUtill.calculateBMI(65, 1.66));
        System.out.println("average = " + MyUtill.average(20, 20, 20));
        /*
    ...
    static void work04UseOfObjectClass() {
        ...
        BankAccount bankaccount = new BankAccount(0001, person1);

        Person person2 = new Person(2);
        BankAccount bankaccount2 = new BankAccount(0002, person2);
        //deposit
        bankaccount.deposit(20000);
        bankaccount2.deposit(40000);
        //withdraw
       bankaccount2.withdraw(10000);
        //transfer
       bankaccount.transfer(2500, bankaccount2);
